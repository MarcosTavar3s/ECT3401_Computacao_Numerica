...
while continua.lower() == "s":
    ...
    if operacao == 1:
        ...
        print(metodo_alternativo_2.converte(numero_base_1, base_origem, base_destino))
        print('-------------------------------------------------------------------------------------------\n')
        ...
        # while not bases.count(base):
            # base = int(input('A base que você inseriu não está contida no escopo deste programa! Tente novamente!\nAs bases disponíveis são de 2 a 26: '))
        
        n1 = input('Digite o numero 01: ')       
        # while not metodo_alternativo_2.valida(n1, base):
            # n1 = input(f'O número escolhido está fora do escopo da base {base}! Tente novamente!\n')

        n2 = input('Digite o numero 02: ')
        # while not metodo_alternativo_2.valida(n2, base):
            # n1 = input(f'O número escolhido está fora do escopo da base {base}! Tente novamente!\n')

        
        print('-------------------------------------------------------------------------------------------\n')
        print(f"Resultado obtido após a aplicação de somas na base {base} será: ")
        print(metodo_alternativo_2.soma_em_base_n(n1, n2, base) + f' (base {base})')
        print('-------------------------------------------------------------------------------------------\n')
        ...
        print(metodo_alternativo_2.multiplica_em_base_n(n1, n2, base) + f' (base {base})')
        print('-------------------------------------------------------------------------------------------\n')

    continua = input('Se deseja continuar a utilizar digite S ou s, caso contrário, o programa será fechado.\n')
